  ...
  return (
    <>
      <Image
        ...
        className="absolute object-cover min-h-full w-full"
        alt="academics1"
      />
      <div className="relative w-full h-full">
        <div className="pt-4 w-full max-w-[90%] mx-auto h-full">
          <Image
            width={1400}
            height={1300}
        ...
        <div className="grid grid-cols-2 mx-auto w-[90%] max-w-[1560px] gap-6">
          <div className="">
            <h1 className="text-center xl:text-3xl font-extrabold my-5">
            ...
            <Image
              ...
              className=" rounded-2xl h-[680px]"
              alt="students"
            />
          </div>
          <div className="px-10 my-auto h-[480px]">
            <h1 className="xl:text-3xl px-5 font-extrabold">Courses</h1>
            <Image
              width={1000}
              height={900}
              ...
              alt="subjects"
            />
            <h1 className=" my-4 xl:text-3xl font-extrabold">Schedule</h1>
        ...
        <div className={sans.className}>
          <Image
            ...
            height={2100}
            src="/assets/background/b2.png"
            className="absolute object-cover rotate-180 h-52 w-full"
            alt="academics1"
          />
          ...
          <div className="relative">
            ...
            <div className="flex justify-between w-[94%] mt-4 mx-auto h-[400px]">
              <div className="w-[48%] h-full relative bg-sky-100">
                ...
                <h1 className="absolute bottom-12 left-11 text-xl">
                  Profession
                </h1>
