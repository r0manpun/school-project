...
export default function Header(){
  ...
  return (
    <header
      ...
      "
    >
      <div className="flex w-full ml-8 lg:ml-14">
      <Image
          className="w-20 h-20 xl:w-24 xl:h-[88px] mt-2"
          width={800}
          height={690}
          src="/logo2.png"
      ...
      {isSmallScreen ? (
        ...
        <li className="text-lg md:h-6 md:w-[284px] font-semibold text-left">
          ...
          <li className="lg:text-base">KOLPATAN-15, Pokhara</li>
        <li className="lg:text-base">ESTD, 2052 B.S (1995 A.D)</li>
        </ul></>
      ): (<>
      <ul className="flex flex-col text-white justify-center -mt-4 ml-2 relative ">
        <li className="text-lg md:h-6 md:w-[284px] font-semibold text-left">
          RAINBOW ACADEMIC HOMES
        </li>
        <li className="text-base">KOLPATAN-15, Pokhara</li>
        <li className="text-base">ESTD, 2052 B.S (1995 A.D)</li>
      </ul>
